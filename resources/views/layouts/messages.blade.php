...
<div style="padding: 10px;border-style: solid;border-width: 1px; margin-top: 2px; margin-left: 30px; margin-right: 30px;">
    <h4><span class='text-secondary'>ID #{{$item->id}} | </span></h4><hr>
    <p>{{$item->body}}</p>
    @auth
...
<form action="\AddMessage" method="get" >
    Message body: <input type="text" name="body" id="msg_body" required>
    <input type="hidden" name="thread_id" value="{{$content[0]->thread_id}}">
    <input type="submit" value="Add message">
</form>
</div>
@endauth
<h4 align="center"><a href="\Threads\{{$content[0]->thread['id']}}">Back</a></h4>
